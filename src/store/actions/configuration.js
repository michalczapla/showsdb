    ...
    return async dispatch => {
        ...
        let configuration=null;
            try {
                ...
                const images_base_url = resultImageConf.data.images.secure_base_url + 'w92'; //wybrany rozmiar obrazkow do wynikow wyszukiwania   
                const backdrop_base_url = resultImageConf.data.images.secure_base_url + 'w780'; //wybrany rozmiar obrazkow do tła szczegółow i logo sieci
                const still_base_url = resultImageConf.data.images.secure_base_url + 'w300'; //wybrany rozmiar obrazkow do podglądu odcinka  
